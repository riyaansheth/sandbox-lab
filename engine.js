(function (root, factory) {
  ...
  const BATTERY_EVERY=1.2,GEN_EVERY=.18,GEN_DOSE=100,GEN_CHAR=.26,GEN_BURN=55,GEN_CHAIN=140; // a generator is a hundred batteries: it fires six times a second, and what it catches is bone in a second
