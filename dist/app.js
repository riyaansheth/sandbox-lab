...
(() => {
  ...
  const state={tool:'grab',spawn:null,selected:null,paused:false,speed:1,category:'all',sub:'all',pointer:{x:0,y:0},worldPointer:{x:0,y:0},inside:false,down:false,pan:null,ropeStart:null,shift:false,rotation:0,sound:false};
  const TOOLS=[
