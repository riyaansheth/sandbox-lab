...
(function (root, factory) {
  ...
  const ITEMS = [
    ...
    { id: 'minigun',  name: 'Minigun',        category: 'Firearms',   description: 'Six barrels, 7.62 x 51 mm, 850 m/s, 40 rounds a second. Hold F and hold on.', w: 112, h: 28, material: 'metal', hp: 400, density: .0016, firearm: { damage: 2.2, speed: 850, rate: 40, auto: true, spread: .045, recoil: .004, muzzle: 58 }, grip: { x: -52, y: 0 }, color: '#454e54' },
